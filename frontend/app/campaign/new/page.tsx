...
export default function NewCampaignPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.detail || "Failed to validate configuration",
      );
    } finally {
      setIsSaving(false);
    }
  ...
  const steps = [
    {
      ...
      description: "Target audience & preferences",
    },
    {
      number: 2,
      title: "Sender Details",
      description: "Your information & offering",
    },
  ];
      ...
      <Card>
        ...
        <CardContent>
          {currentStep === 1 ? (
            ...
            <SenderForm details={senderDetails} onChange={setSenderDetails} />
          )}
        </CardContent>
      </Card>
