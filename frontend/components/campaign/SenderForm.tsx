    ...
    <div className="space-y-6">
      ...
      <div className="pb-4 border-b border-gray-200">
        ...
        <div className="space-y-4">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange({ ...details, organization: e.target.value })
            }
          ...
          <Textarea
            ...
            onChange={(e) =>
              onChange({ ...details, service_offered: e.target.value })
            }
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          Adding these details will make your emails more professional and
          actionable
        </p>
        ...
        <div className="space-y-4">
          <Input
            ...
            onChange={(e) =>
              onChange({ ...details, calendar_link: e.target.value })
            }
